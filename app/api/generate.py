...
def _build_recipe(request: RecipeRequest) -> Recipe:
    ...
    substitutions = [f"Use any available alternative for {name}." for name in ingredient_names[:2]]
